...
interface CraftingPanelProps {
  ...
  ores: OreInventory;
  balls: BallInventory;
  /** Called after a successful craft so the parent can refresh shared state. */
  onBallsCrafted: () => void | Promise<void>;
}
...
export default function CraftingPanel({
  ...
  const oreTypes: OreType[] = ["stone", "iron", "crystal", "mystic", "dark"];
  const ballTypes: BallType[] = ["basic", "iron", "crystal", "mystic", "dark"];
          ...
          {oreTypes.map((oreType) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-lg font-bold text-purple-300">{ores[oreType]}</div>
        ...
        <div className="space-y-3">
          {ballTypes.map((ballType) => {
            ...
            const cost = Object.entries(recipe)
              ...
              .map(([oreType, amount]) => `${amount} ${ORE_DATA[oreType as OreType].name}`)
              .join(" + ");
            ...
            return (
              <button
                ...
                style={{
                  background: canCraft ? "rgba(45,27,78,0.7)" : "rgba(15,10,30,0.7)",
                }}
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right" style={{ fontFamily: "'Cinzel', serif" }}>
          ...
          {ballTypes.map((ballType) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-lg font-bold text-purple-300">{balls[ballType]}</div>
